...
public class Recorder implements OnCompletionListener, OnErrorListener
{
	...
	long					mSampleStart			= 0;	// time at which
															// latest record or
															// play operation
															// started
	int						mSampleLength			= 0;	// length of current
															// sample
	...
	public void setSampleFile(Uri uri)
	{
		mSampleFile = new File(uri.getPath());
	}
	...
	public void startRecording(int outputfileformat, String extension,
			Context context)
	{
		startRecording(outputfileformat, extension, context, MediaRecorder.AudioEncoder.AMR_NB);
	}

	public void startRecording(int outputfileformat, String extension,
			Context context, int encoder)
	{
		stop();
