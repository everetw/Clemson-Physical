...
public abstract class DatabaseObject implements java.io.Serializable
{
	...
	{
		// System.err.println("Deleting object from "+this.getTableName()+
		// " where " + this.getIdKeyName()+" = "+this.getId());
		SQLiteDatabase db = dbh.getWritableDatabase();
		int rc = db.delete(this.getTableName(), this.getIdKeyName() + " = ?", new String[] { String.valueOf(this.getId()) });
