...
public class ExerciseAnnotation extends DatabaseObject
{
	...
	public ExerciseAnnotation(int id, int exercise_id, int video_time,
			String annotation)
	{
	...
	public void setObjectFromJSON(JSONObject j) throws JSONException
	{
		...
		int time = (Integer.parseInt(split[0]) * 60000)
		...
		System.err.println("Annotation for Exercise " + this.getExerciseId()
				+ " at " + time);
	...
	public static ExerciseAnnotation getById(DatabaseHandler dbh, int id)
			throws Exception
	{
	...
	public static ExerciseAnnotation getNextAnnotationByTime(
			DatabaseHandler dbh, int log_id, int time, int interval)
	{
		...
		Cursor cursor = db.query(TABLE_NAME, getDbKeyNames(), DbKeys.KEY_IDEXERCISE.getKeyName()
				+ "=? and "
				+ DbKeys.KEY_EXERCISE_ANNOTATION_VIDEO_TIME.getKeyName()
				+ " between ? and ?",

		new String[] { Integer.toString(log_id), Integer.toString(time),
				Integer.toString(max_time) }, null, null, DbKeys.KEY_EXERCISE_ANNOTATION_VIDEO_TIME.getKeyName()
				+ " ASC", null);
	...
	public static ExerciseAnnotation getPreviousAnnotationByTime(
			DatabaseHandler dbh, int log_id, int time, int interval)
	{
		...
		new String[] { Integer.toString(log_id), Integer.toString(min_time),
				Integer.toString(time) }, null, null, DbKeys.KEY_EXERCISE_ANNOTATION_VIDEO_TIME.getKeyName()
				+ " DESC", null);
			...
			DatabaseHandler dbh, int exercise_id)
	{
		...
		String selectQuery = "SELECT  * FROM " + TABLE_NAME + " WHERE "
				+ DbKeys.KEY_IDEXERCISE.getKeyName() + "="
