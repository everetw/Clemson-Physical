...
/**
 * 
 * This is an improved version of the Android SoundRecorder app. It now supports MPEG4 (AAC) recording and EXTRA_OUTPUT.
 * 
 */

package edu.clemson.soundrecorder;
		...
		Recorder.OnStateChangedListener
{
	...
	static final String			AUDIO_MPEG4					= "audio/mp4";
	static final String			AUDIO_ANY					= "audio/*";
	static final String			ANY_ANY						= "*/*";

	static final int			BITRATE_AMR					= 5900;					// bits/sec
	static final int			BITRATE_3GPP				= 5900;
	static final int			BITRATE_MPEG4				= 32000;

	WakeLock					mWakeLock;
	String						mRequestedType				= AUDIO_ANY;
	Recorder					mRecorder;
	boolean						mSampleInterrupted			= false;
	String						mErrorUiMessage				= null;					// Some
																						// error
																						// messages
																						// are
																						// displayed
	...
	public void onCreate(Bundle icycle)
	{
		...
		if (i != null)
		{
			...
			if (AUDIO_AMR.equals(s) || AUDIO_3GPP.equals(s)
					|| AUDIO_MPEG4.equals(s) || AUDIO_ANY.equals(s)
					|| ANY_ANY.equals(s))
			{
				mRequestedType = s;
			}
			...
			{
				// we only support amr and 3gpp and m4a formats right now
			...
			case R.id.recordButton:
				...
				else
				{
					...
					else if (AUDIO_MPEG4.equals(mRequestedType))
					{
						...
						mRecorder.startRecording(MediaRecorder.OutputFormat.MPEG_4, ".m4a", this, MediaRecorder.AudioEncoder.AAC);
			...
			long playlistId)
	{
		...
		values.put(MediaStore.Audio.Playlists.Members.PLAY_ORDER, Integer.valueOf(base
				+ audioId));
	...
	private Uri createPlaylist(Resources res, ContentResolver resolver)
	{
		...
		if (uri == null)
		{
			new AlertDialog.Builder(this).setTitle(R.string.app_name).setMessage(R.string.error_mediadb_new_record).setPositiveButton(R.string.button_ok, null).setCancelable(false).show();
		}
		return uri;
	}
