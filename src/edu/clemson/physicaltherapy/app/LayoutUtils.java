...
public class LayoutUtils
{
	...
	/**
	 * @fn public static TableRow createTableRow(Context context) Creates a
	 *     table row with no margins and no padding that will expand to the
	 *     entire length of the parent TableLayout.
	 * @param context
	 ...
	 * @param context
	 * @param color
	 *            Numerical representation of color. Use
	...
	/**
	 * @fn public static TextView createTextView(Context context,String
	 *     message,int size,int textColor,int backgroundColor)
	 * @brief Creates a textview object.
	 * @param context
	 * @param message
	 *            Message to be displayed in the text view
	 * @param size
	 *            Text size
	 * @param textColor
	 *            Numerical representation of color. Use
	...
	/**
	 * @fn public static TextView createDateTextView(Context context,String
	 *     message,int size,int textColor,int backgroundColor)
	...
	/**
	 * @fn public static EditText createEditText(Context context,String
	 *     message,int size,int textColor,int backgroundColor)
	 * @brief Creates a textview object.
	 * @param context
	 * @param message
	...
	/**
	 * @fn public static Spinner createSpinner(Context context, String[]
	 *     spinnerList, int backgroundColor)
	 * @brief Creates a Spinner object with default background.
	 * @param context
	 * @param spinnerlist
	 *            list of possible values for the spinner
	 ...
	 * @brief This creates a new WebView object to display the HTML code in
	 *        string.
	 * @param context
	 * @param html
	 *            HTML code to be displayed. This is a string of the code
	 *            itself, not a link to a file.
	...
	//
	// public static void displayYesNoDialog(Context context, String message,
	// String title)
	// {
	//
	//
	...
	public static void loadImage(final Context context, String uriString,
			ImageView imageView)
	{
		try
		{
	...
	public static void loadImage(final Context context, Uri resource,
			ImageView imageView)
	{
		Drawable drawable;
		try
